...
//-------------------------<?php 
// Nom du fichier: "user_create.php"
// Fonction: "Cr̩e les nouveaux membres et affiche le formulaire d'inscription"
// Auteur: "Pascal Viney"
// Adresse e-mail: "yapa22@free.fr"
// ----------------------------------------------------------------------------
...
//-------------------------------
//Cr̩ation du membre dans la BDD
//-------------------------------
...
elseif( !empty( $_POST['action'] ) and $_POST['action'] == 'add' )
{
  ...
  /* ETAPE 1: Formatage des variables */
    ...
    //D̩claration et V̩rification de la conformit̩ des variables
  ...
  /* ETAPE 2: Traitement sur BDD */
    ...
    //On v̩rifie que le pseudo n'existe pas d̩ja
    ...
    //D̩finition de l'activation du compte (selon cfg)
  ...
  /* ETAPE 3: Confirmation */
    ...
    //Envoi du mail de confirmation si la fonction est activ̩e

      $ac = array('non' => 'D̩sactiv̩', 'oui' => 'Activ̩' );
