...
Shiva-authentification
Shiva authentification (v1.3 Bêta) ==> v2.0 Php 7

Le script Shiva authentification v1.3 date de quelques années, mais je le trouvais super sympa. Je l'ai cherché sur le Web, mais on ne le trouve plus. J'ai donc converti cet ancien script vers Php 7, mais je ne suis qu'un amateur. J'ai donc décidé de vous remettre la source d'origine en fichier Zipper et ma version vers Php 7.
...
Bon sur cette version, je n'ai fait qu'une conversion du script originel v1.3 bêta en Php 7 que j'ai donc nommé v2.0. En partageant ce script j'espère pouvoir proposer une version actuelle qui fonctionnera à 100% sur Php 7.
...
-Pas d'images (ou du SVG) -Thème en CSS3 -Utilisation de font-awesome pour les icônes -Multilingues
