...
{
  if ( ( preg_match("%1%", $for) and AUTH_RANG == '1' ) or ( preg_match("%2%", $for) and AUTH_RANG == '2' ) or ( preg_match("%3%", $for) and AUTH_RANG == '3' ) or ( preg_match("%4%", $for) and AUTH_RANG == '4' ) )
  {
    echo $html;
  }
}
